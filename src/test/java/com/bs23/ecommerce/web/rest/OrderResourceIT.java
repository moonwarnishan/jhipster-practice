package com.bs23.ecommerce.web.rest;

import static com.bs23.ecommerce.web.rest.TestUtil.sameInstant;
import static com.bs23.ecommerce.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.bs23.ecommerce.IntegrationTest;
import com.bs23.ecommerce.domain.Order;
import com.bs23.ecommerce.repository.OrderRepository;
import com.bs23.ecommerce.service.dto.OrderDTO;
import com.bs23.ecommerce.service.mapper.OrderMapper;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().totalAmount(DEFAULT_TOTAL_AMOUNT).status(DEFAULT_STATUS).createdAt(DEFAULT_CREATED_AT);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().totalAmount(UPDATED_TOTAL_AMOUNT).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.totalAmount(UPDATED_TOTAL_AMOUNT).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.totalAmount(UPDATED_TOTAL_AMOUNT).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
