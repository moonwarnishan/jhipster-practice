...
class ApplicationUserResourceIT {
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().username(DEFAULT_USERNAME).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().username(UPDATED_USERNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
        return applicationUser;
    }
    ...
    void putExistingApplicationUser() throws Exception {
        ...
        updatedApplicationUser.username(UPDATED_USERNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void partialUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.username(UPDATED_USERNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
